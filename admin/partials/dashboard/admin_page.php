        ...
        <dl class="grid grid-cols-2 text-gray-900 gap-y-6 ">
            ...
            <div class="flex p-2 border rounded mr-5">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center">
                        <dd class="text-gray-500 mr-1"><?=$image_converter_html?></dd>
            ...
            <div class="flex p-2 border rounded mr-5">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center">
                        <dd class="text-gray-500 mr-1"><?=$draft_to_schedule_html?></dd>
            ...
            <div class="flex p-2 border rounded mr-5">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center">
                        <dd class="text-gray-500 mr-1"><?=$ai_configuration_html?></dd>
            ...
            <div class="flex p-2 border rounded mr-5">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center">
                        <dd class="text-gray-500 mr-1"><?=$rewrite_posts_html?></dd>
            ...
            <div class="flex p-2 border rounded mr-5">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center">
                        <dd class="text-gray-500 mr-1"><?=$social_media_html?></dd>
