...
<?php else: ?>
    <form action="<?=$form_action?>" class="max-w-sm mx-left mt-5 ml-5 mb-5">
        ...
        <div class="flex">
            <div class="mb-5">
                <label for="start_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date Time (Indian)</label>
            ...
            <div class="mb-5 ml-5">
                <label for="end_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End Date Time (Indian)</label>
        ...
        <div class="flex">
            <div class="mb-5">
                <label for="posts_limit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Limit (Post count)</label>
            ...
            <div class="mb-5 ml-5">
                <label for="end_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Offset (Skip posts)</label>
