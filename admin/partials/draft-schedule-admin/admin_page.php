...
<div class="max-w-2xl mx-left mt-5 ml-5 mb-5">
    ...
    <button onclick="draft_schedule_admin()" class="mt-5 text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center flex font-semibold ">
