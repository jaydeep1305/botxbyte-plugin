...
<div class="max-w-lg mx-left mt-5 ml-5 mb-5">
    <div class="flex items-center mb-4">        
        <input id="default-checkbox" type="checkbox" name="image_converter_enabled" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  <?php echo !$is_imagick_enabled ? 'disabled' : ''; ?> <?= isset($is_image_converter_enabled)?$is_image_converter_enabled: ''?>>
        <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable Image Converter (convert jpg to webp)</label>
    </div>
...
<?php endif; ?>
    ...
    <button onclick="image_converter_admin()" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex font-semibold mb-5">
