...
<div class="max-w-sm mx-left mt-5 ml-5 mb-5">
    <div class="flex">
        <div class="flex items-center mb-5">
            <input id="rp-Openai" type="radio" value="Openai" name="rp_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  <?php if($rp_type == 'Openai') echo 'checked'; ?> onchange="rp_handle_type_change(this);">
            <label for="rp-Openai" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Open AI</label>
        </div>
        <div class="flex items-center mb-5 ml-5">
            <input id="rp-Azure" type="radio" value="Azure" name="rp_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  <?php if($rp_type == 'Azure') echo 'checked'; ?> onchange="rp_handle_type_change(this);">
            <label for="rp-Azure" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Azure AI</label>
        </div>
    </div>
</div>
        <!-- Openai -->  
        ...
        <button onclick="ai_config_admin()" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex font-semibold ml-5 mb-5">
