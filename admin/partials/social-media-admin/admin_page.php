...
<div class="max-w-sm mx-left mt-5 ml-5 mb-5">
    ...
    <?php if($flag) : ?>
        <div class="mb-5 mt-5">
            <h2 class="mb-2 text-lg font-semibold text-gray-900">Steps to Automate Social Media</h2>
        ...
        <div class="mb-5">
            <label for="ifttt_url" class="block mb-2 text-sm font-medium text-gray-900">Ifttt URL</label>
...
<?php endif; ?>
<?php if($flag) : ?>
    <div class="flex max-w-lg ml-5 ">
        <button onclick="test_social_media('working')" class="text-white bg-indigo-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center flex font-semibold ">
            <span class="text-sm" >Test It !</span>
        </button>
        <button onclick="save_social_media('working')" class="ml-5 text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center flex font-semibold ">
        ...
        <button onclick="save_social_media('not working')" class="ml-5 text-white bg-red-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center flex font-semibold ">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" class="w-4 mr-2">
                <path d="M5 12l5 5l10 -10"></path>
            </svg>
